        ...
        <div className="projects-overall">
            ...
            <div className="projects">
                <div className="projects-main">
                    ...
                    <ProjectSummary weblink="" webpage="youtube.com" title="SolarViz Web App" description="Built using Flask(Python) and ReactJS(JavaScript)., this University Capstone project was built to maonitor energy usage at the University of Cape Town's Hasso-Plaatner D-School Building, in groups of 3"/>
                </div>
